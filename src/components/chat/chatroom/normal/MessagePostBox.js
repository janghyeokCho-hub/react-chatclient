              ...
              {!disabledButtons && (
                <div className="input-icobox">
                  ...
                  {zoomMeet && (
                    ...
                    >
                      <img
                        src="data:image/png;base64,"
                        width="18"
                        height="18"
                      />
                    </button>
                  ...
                  {DEVICE_TYPE === 'd' && useCapture === 'Y' && (
                    ...
                    >
                      <img
                        src="data:image/png;base64,"
                        width="16"
                        height="16"
                      />
                    </button>
