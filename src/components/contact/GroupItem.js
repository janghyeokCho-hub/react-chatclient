        ...
        */
        returnMenu.push({
            ...
            onClick: () =>{
                ...
                const member = userInfo.type == 'U' ? {contactId: userInfo.id}:{ contactId: userInfo.id, companyCode: userInfo.companyCode };
    ...
    */
                ...
                openPopup(
                    {
                      ...
                      message: covi.getDic('Confirm_Delete_Group', '해당 그룹을 삭제하시겠습니까?'),
                      initValue: '',
                      callback: result => {
        ...
        returnMenu.push({
            ...
            onClick: () => {
              if (contact.pChat == 'Y') {
                //그룹정보
                let groupInfos = { id: groupItem.folderID, type: groupItem.folderType };
